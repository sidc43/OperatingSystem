...
// This is a small, readable 8x8 font set (printable ASCII).
// If you want, we can swap to PSF later for a nicer font; this is enough for a real terminal now.
namespace font8x8
{
    const u8 basic[96][8] =
    {
        ...
        { 0x00,0x10,0x38,0x6C,0xC6,0xC6,0xFE,0x00 }, // DEL -> treat as '^?' look
    };
}
